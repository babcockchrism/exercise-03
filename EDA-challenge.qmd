...
dietstrat <- ggplot(data = d, mapping = aes(x = diet_strategy, y = MeanGroupSize)) + geom_boxplot() + xlab("Diet Strategy") + ylab("Mean Group Size")
dietstrat # I for the life of me cannot figure out how to remove the NA plot

 # Frugivores seem to live in slightly larger groups than folivores.
