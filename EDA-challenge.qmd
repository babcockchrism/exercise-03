...
#### "body size dimorphism", AKA how much bigger males are to females
...
#### how many females for every male

DL <- d$DayLength_km
HR <- d$HomeRange_km2
HD <- 2 * sqrt(HR / pi)

#### converts home range area to a diameter

DI <- DL / HD

#### "defensibility index", AKA day range length divided by home range diameter
...
#### compares the amount an animal moves in a day with the amount of time that animal moves in a day across all families

byfamily = overall + facet_wrap(vars(d$Family))
byfamily

#### splits the above comparison into individual families
...
#### compares mean group size and distance traveled in a day

DLvsGS_family <- DLvsGS + facet_wrap(vars(d$Family))
DLvsGS_family

#### separates the above data by family
...
#### transforms above plots using logarithms
...
#### groups all animals into their respective diet strategy groups
...
#### box plots for the diet strategies compared to mean group size

#### Frugivores seeminly tend to live in slightly larger groups than folivores, and omnivores seemingly tend to live in the largest groups out of the three.
